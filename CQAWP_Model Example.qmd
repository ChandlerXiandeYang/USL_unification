...
##| label: fig-histogram
##| fig-pos: 'H'
##| fig-cap: Individual DAR and DAR_Pct Histograms with KDE Determined Quantiles
...
#| message: False
#| warning: False
#| tbl-cap: Cleaning Process Overall Performance for Equipment A by CQAWP with USL-Normalized DAR, CAR, and Mic Data
##| out-height: 40%
##| out-width: 80%
##| label: tbl-CQAWWC
#knitr::include_graphics("Histogram_combined.png")
...
CQAWP_Model
# kable(Eq_CAR1[ ,c("CleaningEvent", "Molecule", "LIMSProjectID", "CAR", "USL", "Swab_Reason", "Classification", "Sampling_Date")], 
#       format = "latex", booktabs = TRUE, longtable = TRUE, caption = "CAR Data", row.names = FALSE) %>%
...
#| message: False
#| warning: False
##label: fig-CQAWWC_Modle
##| fig-pos: 'H'
##| fig-cap: Cleaning Process Overall Performance for Equipment A with USL-Normalized DAR, CAR, and Mic Data
##| out-height: 40%
##| out-width: 80%
#knitr::include_graphics("Histogram_combined.png")
#CQAWWC_Model <- CQAWWC_BAKDEDPonUSLND_CVStage3Monitoring(data1=Eq_DAR, Residue1=DAR, USL1=USL,
                                        # data2=Eq_CAR, Residue2=CAR, USL2=USL,
                                        # data3=Eq_Mic, Residue3=Mic, USL3=USL,
                                        # Fiscal_Year=Fiscal_Year,Time_cut=2025, initial_boot = 500, seed=1234)
#CQAWWC_Model
# kable(Eq_CAR1[ ,c("CleaningEvent", "Molecule", "LIMSProjectID", "CAR", "USL", "Swab_Reason", "Classification", "Sampling_Date")], 
#       format = "latex", booktabs = TRUE, longtable = TRUE, caption = "CAR Data", row.names = FALSE) %>%
#   kable_styling(font_size = 9, position = "center", latex_options = c("scale_down", "striped", "hold_position"))
